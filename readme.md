...
2. 配置DB\_NAME 位于application.yml
3. 配置BASE\_LOCATION 位于application.yml
4. 修改logback-spring.xml下的LOG\_HOME的value值
...
CREATE DATABASE IF NOT EXISTS xxx DEFAULT CHARSET utf8 COLLATE utf8\_general\_ci;
...
修改logback-spring.xml下的LOG\_HOME的value值
...
https://blog.csdn.net/qq\_46728644/article/details/120772577
...
https://blog.csdn.net/weixin\_42822484/article/details/107893586
